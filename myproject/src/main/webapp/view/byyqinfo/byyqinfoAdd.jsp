...
<div class="layui-container">
    ...
    <form class="layui-form  layui-form-pane" action="${ctx}/byyqinfo/insert" method="post" style="margin: 50px auto;">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" name="mcontent" id="mcontent" value="" lay-verify autocomplete="off"
                       placeholder="请输入指标点"
                       class="layui-input">
            </div>
        </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" name="m1" id="m1" value="" lay-verify autocomplete="off"
                       placeholder="请输入目标1"
                       class="layui-input">
            </div>
        </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" name="m2" id="m2" value="" lay-verify autocomplete="off"
                       placeholder="请输入目标2"
                       class="layui-input">
            </div>
        </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" name="m3" id="m3" value="" lay-verify autocomplete="off"
                       placeholder="请输入目标3"
                       class="layui-input">
            </div>
        </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" name="mintro" id="mintro" value="" lay-verify autocomplete="off"
                       placeholder="请输入要求备注"
                       class="layui-input">
            </div>
        </div>
