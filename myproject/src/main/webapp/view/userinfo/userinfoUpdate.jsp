...
<div class="layui-container">
    ...
    <form class="layui-form  layui-form-pane" action="${ctx}/userinfo/update" method="post" style="margin: 50px auto;">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" name="name" id="name" value="${userinfo.name}" lay-verify readonly autocomplete="off"
                       placeholder="请输入姓名"
                       class="layui-input">
            </div>
        </div>
        ...
        <div class="layui-form-item layui-form-text">
            ...
            <div class="layui-input-block">
                         <textarea rows="5" name="content" id="role" value="${userinfo.role}" placeholder="请输入个人评价"
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="password" name="password" id="password" value="${userinfo.password}" lay-verify
                       autocomplete="off"
                       placeholder="请输入密码"
                       class="layui-input">
            </div>
