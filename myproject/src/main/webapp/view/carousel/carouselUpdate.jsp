...
<div class="layui-container">
    ...
    <form class="layui-form  layui-form-pane" action="${ctx}/carousel/update" method="post" style="margin: 50px auto;">

        <div class="layui-form-item">
            <label class="layui-form-label">编号</label>
            <div class="layui-input-block">
                <input type="text" name="id" readonly id="id" value="${carousel.id}" lay-verify autocomplete="off"
                       placeholder="请输入编号"
                       class="layui-input">
            </div>
        </div>
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" name="name" id="name" value="${carousel.name}" lay-verify autocomplete="off"
                       placeholder="请输入名称"
                       class="layui-input">
            </div>
        </div>
        <div class="layui-form-item ">
            ...
            <div class="layui-input-block">
                ...
                <input type="text" id="picurl" name="picurl" value="${carousel.picurl}" lay-verify="required"
