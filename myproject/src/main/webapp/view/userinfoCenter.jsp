...
<head>
    <meta charset="utf-8">
    <title>工程教育认证达成度分析系统-个人信息修改</title>
            ...
            <form class="layui-form layui-form-pane" action="" style="width:80%;margin:0 auto;margin-top: 2%;"
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <input type="text" name="intro" id="intro" readonly value="${userinfo.intro}" lay-verify
                               autocomplete="off"
                               placeholder="请输入备注"
                               class="layui-input">
                    </div>
                ...
                <div class="layui-form-item layui-form-text">
                    ...
                    <div class="layui-input-block">
                         <textarea rows="5" name="role" id="role"  placeholder="请输入个人评价"
                                   class="layui-textarea">${userinfo.role}</textarea>
                    </div>
                </div>
                <div class="layui-form-item">
                    <div class="layui-form-item">
