...
<div class="layui-container">
    ...
    <form class="layui-form  layui-form-pane" action="${ctx}/scoreinfo/insert" method="post" style="margin: 50px auto;">

        <div class="layui-form-item">
            <label class="layui-form-label">姓名</label>
            <div class="layui-input-block">
                <input type="text" name="uname" id="uname" value="" lay-verify autocomplete="off"
                       placeholder="请输入学号"
                       class="layui-input">
            </div>
        </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" name="tname" id="tname" value="" lay-verify autocomplete="off"
                       placeholder="请输入课程名称"
                       class="layui-input">
            </div>
        </div>
